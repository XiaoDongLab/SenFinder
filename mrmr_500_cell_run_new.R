...
#read files
#setwd("C://Users/mahmu052/Documents/UMN/PROJ_MACHINE/RNA_SEQ_RUN/data_01222024/simrun_cell_unix")
dat1=read.csv("./cellage_final_dat_02132024.csv")
...
# create mrmr object
dat2[,1:864] <- lapply(dat2[,1:864],as.numeric)
...
# use all save variable to make dataframe(1 to 6)
#simout1<-cbind(dst,rft,svt,rst)
#(1 to 500)
simout<-cbind(dst,rft,svt,rst)

#rowbind
#dddd<-rbind(simout1,simout)
# write the output
write.csv(simout,"./simout_cellage_02132024.csv")
