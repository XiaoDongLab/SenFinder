...
refgenome=/data/gv_h/smahmud/proj_machine/GSE63577/hg19d/star_hg19_grch37_50
gene=/data/gv_h/smahmud/proj_machine/GSE63577/hg19d/Homo_sapiens.GRCh37.87.gtf
genome=/data/gv_h/smahmud/proj_machine/GSE63577/hg19d/star_hg19_grch37_50/Homo_sapiens.GRCh37.dna_sm.primary_assembly.fa
refname=/data/gv_h/smahmud/proj_machine/GSE63577/hg19d/star_hg19_grch37_50/Homo_sapiens.GRCh37.87.ercc.rsem
...
# write summary
file=processing_summary_gse63577.csv
if test -f "$file"; then
  echo "$file exists."
else
...
pcrpcrdupremoved" \
> processing_summary_gse63577.csv
fi
