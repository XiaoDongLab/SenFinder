###Pipeline created by Shamsed Mahmud at 27th March 2023###
...
refgenome=/data/gv_h/smahmud/proj_machine/GSE64553/hg19d_50/star_hg19_grch37_50
gene=/data/gv_h/smahmud/proj_machine/GSE64553/hg19d_50/Homo_sapiens.GRCh37.87.gtf
genome=/data/gv_h/smahmud/proj_machine/GSE64553/hg19d_50/star_hg19_grch37_50/Homo_sapiens.GRCh37.dna_sm.primary_assembly.fa
refname=/data/gv_h/smahmud/proj_machine/GSE64553/hg19d_50/star_hg19_grch37_50/Homo_sapiens.GRCh37.87.ercc.rsem

np=8
sn=${1}

## the start ###
echo "RS pipeline version 2023.04.10 by Shamsed Mahmud"; echo "Sample ID: "${sn}; echo "Processing starts on"; date; echo "==========";
...
# write summary
file=processing_summary_gse64553.csv
if test -f "$file"; then
  echo "$file exists."
else
...
pcrpcrdupremoved" \
> processing_summary_gse64553.csv
fi
